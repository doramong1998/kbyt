...
export default connect(
  ({
    ...
    dataTable: company.listCompany,
    loadingGet: loading.effects["company/getList"],
    loadingCreate: loading.effects["company/create"],
    loadingUpdate: loading.effects["company/update"],
    loadingDelete: loading.effects["company/deleteOne"],
  })
)(ListNew);
